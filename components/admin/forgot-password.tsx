...
export default function ONCGResetPasswordPage() {
  ...
  const handleRequestReset = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || "https://oncgglobal.ingata-spro.com/api"}/users/request-reset`,
        {
          method: "POST",
          headers: {
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || "https://oncgglobal.ingata-spro.com/api"}/users/verify-otp`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleResetPassword = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || "https://oncgglobal.ingata-spro.com/api"}/users/reset`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
